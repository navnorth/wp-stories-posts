			...
			<?php
				...
				<?php get_sort_box(); ?>
						...
						if ($post_count>10 & $paged<$max_page) {
							...
							echo '<div class="col-md-12 pblctn_paramtr padding_left"><a href="?page='.($paged+1).'" data-page-number="'.($paged+1).'" data-page="story_tag" data-base-url="'.$base_url.'" data-max-page="'.$max_page.'" data-posts="'.json_encode($postids).'" class="btn-load-more">Load More</a></div>';		
						}
						?>
					</div>
                    <?php
